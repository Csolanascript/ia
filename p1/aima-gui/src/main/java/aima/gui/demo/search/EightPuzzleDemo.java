...
public class EightPuzzleDemo {
	static CanibalesBoard boardWithThreeMoveSolution = new CanibalesBoard(
			new int[] { 1, 2, 5, 3, 4, 0, 6, 7, 8 });;

	static CanibalesBoard random1 = new CanibalesBoard(new int[] { 1, 4, 2,
			7, 5, 8, 3, 0, 6 });

	static CanibalesBoard extreme = new CanibalesBoard(new int[] { 0, 8, 7,
			6, 5, 4, 3, 2, 1 });
	...
	private static void eightPuzzleDLSDemo() {
		...
		try {
			Problem problem = new Problem(boardWithThreeMoveSolution, CanibalesFunctionFactory
	...
	private static void eightPuzzleIDLSDemo() {
		...
		try {
			Problem problem = new Problem(random1, CanibalesFunctionFactory
					.getActionsFunction(), CanibalesFunctionFactory
					.getResultFunction(), new CanibalesGoalTest());
