...
public class EightPuzzleDemo2 {
	...
	public static void main(String[] args) {
      ...
      private static void eightPuzzleSearch(Search busqueda , EightPuzzleBoard estado, String problem, Boolean ejecutar) {
    		...
    		try {
    			...
    			String complEsp = "";
    			String complT = "";
    			double estimacionTiempo = 0;
    			double calculoCompEsp = 0;
